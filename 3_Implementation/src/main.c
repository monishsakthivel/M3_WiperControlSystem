...
static volatile int SCount = 0, count=0;		//Global variables
												//Scount was the no of times the switch was pressed
												//count was a simple variable to count loop
